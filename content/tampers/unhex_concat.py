...
__type__ = "wrap SQL string literals in UNHEX(HEX(...)) function calls"
__category__ = "sqli"
...
def _to_unhex(match):
    ...
    return "UNHEX('{}')".format(content.encode("utf-8").hex())
...
def tamper(payload, **kwargs):
    ...
    if rest[0] == "'":
        head, rest = "'", rest[1:]
    return head + _STRING_LITERAL.sub(_to_unhex, rest)
